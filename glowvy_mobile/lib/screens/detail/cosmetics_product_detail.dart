...
class _CosmeticsProductDetailState extends State<CosmeticsProductDetail> {
  ...
  void initState() {
    ...
    productModel.getIngredients(product.sid).then((onValue) {
      if (mounted) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    Route _createRoute() {
      var thumbnailList = []..add(product.thumbnail);
      return PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) =>
            ImageGalery(images: product.descImages ?? thumbnailList, index: 1),
          ...
          children: <Widget>[
            Column(
              children: <Widget>[
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                    product.descImages != null
                                        ? product.descImages.length.toString()
                                        : '0',
                        ...
                        children: <Widget>[
                          Container(
                              ...
                              child: Text(product.brand.name,
                                  maxLines: 2, style: textTheme.bodyText2)),
                          Text(product.name,
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(left: 40.0, right: 30, top: 10),
                  child: Row(
                                    ...
                                    children: <Widget>[
                                      Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: <Widget>[
                                            const Spacer(),
                                            Text(S.of(context).ingredientInfo,
                                      ...
                                      if (!isLoading)
                                        Column(children: renderIngredients()),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          forwardIcon(context, kDarkYellow),
                                        ],
                                      ),
                                      const SizedBox(height: 18)
                                    ],
