...
class CartModel with ChangeNotifier {
  ...
  //     var price = Tools.getPriceProductValue(cartItems[key].product, currency,
  //         onSale: true);
  ...
  // double getImportTax() {
  //   var importTaxPerItem = 16000;
  //   totalImportTax = totalCartQuantity.toDouble() * importTaxPerItem.toDouble();
